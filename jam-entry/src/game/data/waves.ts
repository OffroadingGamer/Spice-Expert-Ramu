/**
 * The shift, rush by rush. Each rush is a burst of tickets down the rail (endless waves follow; see below). Entries in a wave spawn sequentially (with a
...
// ---------------------------------------------------------------------------
// OVERTIME: once the authored rushes above are cleared, tickets keep coming,
