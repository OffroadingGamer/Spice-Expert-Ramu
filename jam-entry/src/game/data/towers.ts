/**
 * The stations: the tools of the trade. Each one works tickets that pass
 * within range; stats are per LEVEL 1, and each
...
export const TOWERS: TowerDef[] = [
    {
        ...
        metaUnique: {
            ...
            maxLevel: 10,
            name: 'Sharp Knife',
            desc: 'Perfect sear chance (does 2x the work)',
        },
    },
    {
        id: 'owl',
        ...
        metaUnique: {
            ...
            maxLevel: 10,
            name: 'Deep Chill',
            desc: 'Tickets hold on the pass longer',
        },
    },
    {
        id: 'bear',
