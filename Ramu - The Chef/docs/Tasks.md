...
**Last updated:** Sep 9 2026, 07:15 IST
...
**Private:** **v1.34.0** — the belt Test Mode build, 24 rounds, `3f95f5a`. **Never public**; `set-public` has never been run on it. [KitchenMode.md](KitchenMode.md) §6.22
