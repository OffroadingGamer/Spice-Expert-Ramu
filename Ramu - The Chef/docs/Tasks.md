...
⏸️ **Round queue, updated Sep 10:** ✅ **1· Balance — DONE** (Round I, `ed2ef78`) · **1b· Round J — the stag tuning pass** (shift curve growth out of `hpMult` and into count; a pass, not a round) — handover written · **2· Art generation** (nine backdrops, parallel with 1b) · **3· Visual** (tower reskin · backdrops · build sidebar · ghost slots · HUD rename · wave roster panel) · **4· Round B** (GDD §10.11b).
