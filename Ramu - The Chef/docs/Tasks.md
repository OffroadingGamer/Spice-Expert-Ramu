...
**Last updated:** Sep 9 2026, 03:00 IST
...
**Private:** **v1.32.0** — the belt Test Mode build, 22 rounds, `4bc537b`. **Never public**; `set-public` has never been run on it. [KitchenMode.md](KitchenMode.md) §6.19
