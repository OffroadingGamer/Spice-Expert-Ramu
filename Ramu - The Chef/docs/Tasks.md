...
**Last updated:** Sep 9 2026, 05:00 IST
...
**Private:** **v1.33.0** — the belt Test Mode build, 23 rounds, `64cb92b`. **Never public**; `set-public` has never been run on it. [KitchenMode.md](KitchenMode.md) §6.20
